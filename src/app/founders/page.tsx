                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    <Card className="shadow-sm rounded-2xl p-8 md:p-12 border bg-card">
                        ...
                        <div className="space-y-4 text-muted-foreground">
                            ...
                            <p>Founded by two visionary developers Tobiloba Olujimi and Dan Adelusi, omniai blends deep technical expertise in full-stack engineering, AI integration, and low-code platforms like n8n, Supabase, and OpenRouter. Together, we develop AI systems that power education (omniai for FUOYE), business automation (Nexus, AssistX), and live data solutions (Nova News Agent).</p>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start max-w-6xl mx-auto">
                        ...
                        <Card className="flex flex-col items-center shadow-sm hover:shadow-lg transition-all duration-300 rounded-2xl hover:-translate-y-1 p-6 md:p-8 h-full">
                            ...
                            <CardContent className="p-0 pt-6 text-muted-foreground text-center">
                                <p>Dan is a systems thinker with a strong grip on full-stack engineering, AI workflow architecture, and scalable automation pipelines. At omniai, he co-leads everything from architecture to execution, designing AI systems that serve real-world needs fast, flexible, and future-ready.</p>
                                <p className="mt-4">Dan specializes in n8n-based automations, GPT integrations, and end-to-end solutions that reduce friction and boost output. His work includes leading the development of the Nexus Dashboard, powering automation across lead generation, education, and CRM syncing.</p>
                                <p className="mt-4">Dan builds with a clear philosophy: automation should make work easier, not more complicated. Every tool he designs is engineered to deliver results without noise — just clean, intelligent output.</p>
                            </CardContent>
                        </Card>

                        {/* Tobiloba Olujimi Card */}
                        <Card className="flex flex-col items-center shadow-sm hover:shadow-lg transition-all duration-300 rounded-2xl hover:-translate-y-1 p-6 md:p-8 h-full">
                            <Image
                                src="/tobiloba.jpg"
                            ...
                            <CardContent className="p-0 pt-6 text-muted-foreground text-center">
                                <p>Tobiloba co-founded omniai with a mission to bring high-performance automation to businesses that need speed, scale, and simplicity. He co-leads the development and deployment of every AI system under the brand from product architecture to backend integrations.</p>
                                <p className="mt-4">With a sharp eye for systems performance, Tobi’s strengths lie in building resilient infrastructure, connecting APIs, and ensuring every AI agent works seamlessly across platforms like WhatsApp, websites, and CRMs. His projects includes: WhatsApp-based assistant, real-time scraping bots, and intelligent customer response agents and custom automation for educational and service-based platforms.</p>
                                <p className="mt-4">Tobi believes every great automation is invisible it should work so smoothly that users forget it's even AI. That belief shapes how he builds, deploys, and improves everything under the Omniai banner.</p>
                            </CardContent>
                        </Card>
                    </div>
                </div>
